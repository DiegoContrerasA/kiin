...
interface WebFilterSelectorProps {
...
const WebFilterSelector = ({ date, setDate, adults, setAdults, children, setChildren, onSearch, disabled }: WebFilterSelectorProps) => {
...
export default WebFilterSelector;